...
const path = {
	build: {
		...
		resources: distPath + '/',
		svgsprites: distPath + 'assets/templates/img/',
	},
	src: {
		html: srcPath + '*.html',
		...
		images:
			srcPath + 'assets/templates/img/**/*.{jpg,png,svg,gif,ico,webp}',
		fonts: srcPath + 'assets/templates/fonts/**/*.{ttf,otf}',
		resources: srcPath + 'assets/templates/resources/**/*.*',
		svgsprites: srcPath + 'assets/templates/svgsprites/*.svg',
	},
	watch: {
		html: srcPath + '**/*.html',
		js: srcPath + 'assets/templates/js/**/*.js',
		css: srcPath + 'assets/templates/styles/scss/**/*.scss',
		images:srcPath + 'assets/templates/img/**/*.{jpg,png,svg,gif,ico,webp,webmanifest,xml,json}',
		fonts: srcPath + 'assets/templates/fonts/**/*.{ttf,otf}',
		resources: srcPath + 'assets/templates/resources/**/*.*',
		svgsprites: srcPath + 'assets/templates/svgsprites/*.svg',
	},
...
export default series(clean, html, css, js, fonts, images, svgSprites, resources, parallel(server,startWatch))
export let build = series(toProd,clean, html, css, js, fonts, images, svgSprites, resources)
